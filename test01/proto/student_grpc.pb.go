...
const (
	Hello_Hello_FullMethodName = "/student.Hello/Hello"
)
...
type HelloClient interface {
	Hello(ctx context.Context, in *Student, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *helloClient) Hello(ctx context.Context, in *Student, opts ...grpc.CallOption) (*Response, error) {
...
type HelloServer interface {
	Hello(context.Context, *Student) (*Response, error)
...
func (UnimplementedHelloServer) Hello(context.Context, *Student) (*Response, error) {
...
func _Hello_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServer).Hello(ctx, req.(*Student))
	}
